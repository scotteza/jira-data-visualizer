...
internal class GraphVizDataPainterShould
{
	...
	subgraph cluster_0 {
		PROJ_5 [shape=""rectangle"" label=""Task: Task in epic""];
		PROJ_6 [shape=""rectangle"" label=""Bug: Bug in epic""];
		PROJ_7 [shape=""rectangle"" label=""Story: Story in epic""];
		label = ""PROJ-4"";
	}
	subgraph cluster_1 {
		PROJ_9 [shape=""rectangle"" label=""Task: Task in epic 2""];
		label = ""PROJ-8"";
	}
	PROJ_1 [shape=""rectangle"" label=""Task: Testing 123 Task Without Epic""];
	PROJ_2 [shape=""rectangle"" label=""Bug: Testing 123 Bug Without Epic""];
	PROJ_3 [shape=""rectangle"" label=""Story: Testing 123 Story Without Epic""];
}
";
